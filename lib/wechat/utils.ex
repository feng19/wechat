defmodule WeChat.Utils do
  ...
  def work_doc_link_prefix, do: "https://open.work.weixin.qq.com/api/doc/9000"
  def new_work_doc_link_prefix, do: "https://developer.work.weixin.qq.com/document/path"
