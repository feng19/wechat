defmodule WeChat.CardManaging do
  ...
  @doc """
  查看卡券详情 - [Official API Docs Link](#{@doc_link}#2){:target="_blank"}
  """
  ...
  @doc """
  批量查询卡券列表 - [Official API Docs Link](#{@doc_link}#3){:target="_blank"}
  """
  ...
  @doc """
  批量查询卡券列表 - 只获取指定状态 - [Official API Docs Link](#{@doc_link}#3){:target="_blank"}
  """
  ...
  @doc """
  更改卡券信息 - [Official API Docs Link](#{@doc_link}#4){:target="_blank"}
  """
  ...
  @doc """
  修改库存 - [Official API Docs Link](#{@doc_link}#5){:target="_blank"}
  """
  ...
  @doc """
  更改Code - [Official API Docs Link](#{@doc_link}#6){:target="_blank"}
  """
  ...
  @doc """
  删除卡券 - [Official API Docs Link](#{@doc_link}#7){:target="_blank"}
  """
  ...
  @doc """
  设置卡券失效接口 - 非自定义code卡券的请求 - [Official API Docs Link](#{@doc_link}#8){:target="_blank"}
  """
  ...
  @doc """
  设置卡券失效接口 - 自定义code卡券的请求 - [Official API Docs Link](#{@doc_link}#8){:target="_blank"}
  """
  ...
  @doc """
  拉取卡券概况数据 - [Official API Docs Link](#{@doc_link}#10){:target="_blank"}
  """
  ...
  @doc """
  获取免费券数据 - [Official API Docs Link](#{@doc_link}#11){:target="_blank"}
  """
  ...
  @doc """
  获取免费券数据 - 只获取指定卡券 - [Official API Docs Link](#{@doc_link}#11){:target="_blank"}
  """
  @spec get_card_analysis(
          WeChat.client(),
          Card.card_id(),
