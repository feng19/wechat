defmodule WeChat.MiniProgram.Search do
  ...
  @doc """
  图片搜索
  - [官方文档](https://developers.weixin.qq.com/miniprogram/dev/api-backend/open-api/search/search.imageSearch.html){:target="_blank"}
  ...
  @doc """
  页面搜索(binary)
  - [官方文档](https://developers.weixin.qq.com/miniprogram/dev/api-backend/open-api/search/search.siteSearch.html){:target="_blank"}
  ...
  @doc """
  提交页面(binary)
  - [官方文档](https://developers.weixin.qq.com/miniprogram/dev/api-backend/open-api/search/search.submitPages.html){:target="_blank"}
