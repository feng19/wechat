defmodule WeChat.Work.WeDrive.SpaceManagement do
  ...
  @doc """
  新建空间
  - [官方文档](https://developer.work.weixin.qq.com/document/path/93655){:target="_blank"}
  """
  ...
  @doc """
  重命名空间
  - [官方文档](https://developer.work.weixin.qq.com/document/path/97856){:target="_blank"}
  """
  ...
  @doc """
  解散空间
  - [官方文档](https://developer.work.weixin.qq.com/document/path/97857){:target="_blank"}
  """
  ...
  @doc """
  获取空间信息
  - [官方文档](https://developer.work.weixin.qq.com/document/path/97858){:target="_blank"}
  """
