defmodule WeChat.Work.Living do
  ...
  @doc """
  创建预约直播 -
  [官方文档](https://developer.work.weixin.qq.com/document/path/93637){:target="_blank"}
  """
  ...
  @doc """
  修改预约直播 -
  [官方文档](https://developer.work.weixin.qq.com/document/path/93640){:target="_blank"}
  """
  ...
  @doc """
  获取直播详情 -
  [官方文档](https://developer.work.weixin.qq.com/document/path/93635){:target="_blank"}
  """
  ...
  @doc """
  取消预约直播 -
  [官方文档](https://developer.work.weixin.qq.com/document/path/93638){:target="_blank"}
  """
  ...
  @doc """
  删除直播回放 -
  [官方文档](https://developer.work.weixin.qq.com/document/path/93874){:target="_blank"}
  """
  ...
  [官方文档](https://developer.work.weixin.qq.com/document/path/93641#获取微信观看直播凭证){:target="_blank"}
  """
  ...
  @doc """
  获取成员直播ID列表 -
  [官方文档](https://developer.work.weixin.qq.com/document/path/93634){:target="_blank"}
  """
  ...
  @doc """
  获取直播观看明细 -
  [官方文档](https://developer.work.weixin.qq.com/document/path/93636){:target="_blank"}
  """
  ...
  @doc """
  获取跳转小程序商城的直播观众信息 -
  [官方文档](https://developer.work.weixin.qq.com/document/path/94442){:target="_blank"}
  """
