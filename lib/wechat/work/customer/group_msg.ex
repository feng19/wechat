defmodule WeChat.Work.Customer.GroupMsg do
  ...
  @doc """
  创建企业群发 -
  [官方文档](https://developer.work.weixin.qq.com/document/path/92135){:target="_blank"}
  ...
  @doc """
  提醒成员群发 -
  [官方文档](https://developer.work.weixin.qq.com/document/path/97610){:target="_blank"}
  ...
  @doc """
  停止企业群发 -
  [官方文档](https://developer.work.weixin.qq.com/document/path/97611){:target="_blank"}
  ...
  @doc """
  获取群发记录列表 -
  [官方文档](https://developer.work.weixin.qq.com/document/path/93338#获取群发记录列表){:target="_blank"}
  ...
  @doc """
  获取群发成员发送任务列表 -
  [官方文档](https://developer.work.weixin.qq.com/document/path/93338#获取群发成员发送任务列表){:target="_blank"}
  """
  ...
  @doc """
  获取企业群发成员执行结果 -
  [官方文档](https://developer.work.weixin.qq.com/document/path/93338#获取企业群发成员执行结果){:target="_blank"}
  """
